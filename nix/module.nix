# NixOS module for Fısıltı speech-to-text
#
...
# Usage in your flake:
#
#   inputs.fisilti.url = "github:umitaltintas/fisilti";
#
#   nixosConfigurations.myhost = nixpkgs.lib.nixosSystem {
#     modules = [
#       fisilti.nixosModules.default
#       { programs.fisilti.enable = true; }
#     ];
#   };
{
  config,
...
let
  cfg = config.programs.fisilti;
in
{
  options.programs.fisilti = {
    enable = lib.mkEnableOption "Fısıltı offline speech-to-text";
